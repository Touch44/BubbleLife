...
const SHELL_FILES = [
  ...
  './styles/tokens.css?v=4.7.8', './styles/layout.css?v=4.7.8',
  './styles/components.css?v=4.7.8', './styles/dark.css?v=4.7.8',
