/**
 * FamilyHub v5.2.5 — Service Worker (sw.js)
 * [minor] Phase 2: condition UI, quiet hours, timer in form, reminder badges, template library
 */
'use strict';

const APP_VERSION   = '5.2.5'; // [MAJOR] Phase 3: NLP reminders, auto-rules engine, chained reminders, analytics
...
const SHELL_FILES = [
  ...
  './services/auto-reminder-rules.js', // [v5.2.5] Phase 3: auto-rules engine
  './views/reminder-analytics.js',     // [v5.2.5] Phase 3: reminder analytics view
