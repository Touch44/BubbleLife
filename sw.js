...
const APP_VERSION   = '6.3.1'; // [v6.2.1] Bug audit: timer listener leaks x3, badge CSS, panel open UX, entity-panel plannedDuration pre-select, getSession ref // [v6.2.0] Tab pinning (per-account), floating timer panel, task period overlap checking, context banner fix, dashboard timer widget // [v6.1.1] Text cutoff fixes + auto-deadline + complete project flow + smart duplication (4-tab modal, velocity chart, heatmap, leaderboard, badges)
