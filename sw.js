...
const SHELL_FILES = [
  ...
  './styles/tokens.css?v=4.7.5', './styles/layout.css?v=4.7.5',
  './styles/components.css?v=4.7.5', './styles/dark.css?v=4.7.5',
