...
const SHELL_FILES = [
  ...
  './styles/tokens.css?v=4.7.6', './styles/layout.css?v=4.7.6',
  './styles/components.css?v=4.7.6', './styles/dark.css?v=4.7.6',
