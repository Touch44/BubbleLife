...
const BUILT_IN_ENTITY_TYPES = [
  ...
  // ── 1. task ─────────────────────────────────────────────── //
  {
    ...
    fields: [
      ...
      field('executionDate', 'date',     { label: 'Execution Date' }),
      field('executionTime', 'time',     { label: 'Execution Time', placeholder: '06:00', helpText: 'Time this task will be carried out (defaults to Due Date if empty)' }),
